    ...
    return (
        <>
            <div className='mx-[20vw] mt-10'>
                ...
                <div className='grid grid-cols-[1fr_max-content] mt-10 gap-5'>
                    <div className='flex flex-col gap-4'>
                        <h1 className='text-5xl font-semibold mb-5'>Helping people finding their desired Job.</h1>
                        ...
                        <p className='text-lg text-gray-600 mt-4'>With a user-friendly interface and advanced search features, we strive to provide the best experience for both job seekers and employers.</p>
                    </div>
